...
const toggleTheme = () => {
  ...
  if(btn) btn.textContent = next==='light' ? '🌙 Dark' : '☀️ Light';
        ...
        <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
          <button onClick={toggleTheme} style={{background:'transparent',border:'1px solid rgba(200,133,90,0.3)',color:'#f5ede3',padding:'4px 10px',borderRadius:100,fontSize:14,cursor:'pointer',lineHeight:1}}>
            {theme === "dark" ? "☀️" : "🌙"}
          </button>
...
Book your first free lesson
      ...
      <p style="font-size:13px;color:#9a7860;margin-bottom:12px;font-family:'DM Sans',system-ui">Or find out your English level right now:</p>
      <a href="/placement-test" class="lwv-btn-secondary" id="lwv-cta1" style="display:inline-flex">✦ Take placement test</a>
    </div>
    <div class="lwv-stats">
    ...
    <div class="lwv-about-grid">
      ...
      <div class="lwv-about-text">
        ...
        <div style="display:flex;gap:10px;flex-wrap:wrap;margin-top:24px">
          <a href="https://t.me/englishwith_viky" target="_blank" class="lwv-btn-secondary" style="font-size:13px;padding:11px 20px">✈️ Contact me on Telegram</a>
          <a href="/request" class="lwv-btn-primary" style="font-size:13px;padding:11px 20px" id="lwv-about-cta">📝 Book your free lesson</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="lwv-price-note" style="color:#c8855a;font-weight:600">60 zł/lesson · save 14%</div>
      ...
      <div class="lwv-price-card featured">
        ...
        <div style="display:flex;align-items:baseline;gap:10px;margin-bottom:4px">
          ...
          <span style="font-family:'Playfair Display',serif;font-size:28px;font-weight:700;color:#f5ede3;white-space:nowrap">1000 zł</span>
        </div>
        <div class="lwv-price-note" id="lwv-pnote2" style="color:#c8855a;font-weight:600;margin-bottom:18px">per person · 3 months · save 17%</div>
        <ul class="lwv-price-features">
      ...
      <div class="lwv-price-card" style="opacity:0.5;pointer-events:none;position:relative">
        ...
        <div style="text-align:center;padding:14px;border-radius:100px;border:1px solid rgba(200,133,90,0.2);color:#9a7860;font-size:14px;font-family:'DM Sans',system-ui">🕐 Will be available soon</div>
      </div>
    </div>
  </div>
</section>
